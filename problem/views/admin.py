...
class AddContestProblemAPI(APIView):
    ...
    def post(self, request):
        ...
        # old_test_case_id = problem.test_case_id
        # new_test_case_id = rand_str()
        # old_test_case_dir = os.path.join(settings.TEST_CASE_DIR, old_test_case_id)
        # new_test_case_dir = os.path.join(settings.TEST_CASE_DIR, new_test_case_id)
        # shutil.copytree(old_test_case_dir, new_test_case_dir)
