...
class UserRegisterSerializer(serializers.Serializer):
    ...
    sno = serializers.CharField(max_length=12)
...
class UserAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "admin_type", "problem_permission", "real_name", "sno",
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ["id", "username", "email", "admin_type", "problem_permission", "sno",
                  "create_time", "last_login", "two_factor_auth", "open_api", "is_disabled"]
...
class StudentCourseRequestSerialzier(serializers.Serializer):
    course_id = serializers.IntegerField()
    is_selected = serializers.CharField(max_length=1)