...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI,
                        ...
                        UserLoginAPI, UserLogoutAPI, UsernameOrEmailOrSnoCheck,
                        AvatarUploadAPI, TwoFactorAuthAPI, UserProfileAPI, UserCourseAPI,
...
urlpatterns = [
    ...
    url(r"^check_username_or_email_or_sno", UsernameOrEmailOrSnoCheck.as_view(), name="check_username_or_email"),
    ...
    url(r"^course_list/?$", UserCourseAPI.as_view(), name="user_course_list_api")
]
